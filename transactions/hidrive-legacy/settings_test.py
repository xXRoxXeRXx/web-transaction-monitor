...
class HiDriveLegacySettingsTest(MonitorBase):
    ...
    def run(self) -> None:
        ...
        def login_logic():
            ...
            # HiDrive keeps active background traffic; rely on UI readiness instead.
        ...
        def navigate_to_settings():
            ...
            self.page.wait_for_selector('li.sj-navigation-item[data-name="my.files"] a', timeout=30000)
